...
namespace AdminSuite.CustomerCreation
{
    public class CreateCustomers
    {
        ...
        private const string StrPasswrd = "123456";
        ...
        public string SelfExcludedCustomer(ISelenium myBrowser, string strUserCreated)
        {
            _isUpdateCustomersResourceFile = false;
            //string slfExclCust = "Slf";
            //  string guidslf = Guid.NewGuid().ToString().Substring(0, 4);
        ...
        public string SuspCustomer(ISelenium myBrowser)
        {
            string strUser;
            _isUpdateCustomersResourceFile = false;
        ...
        public string SuspCustomer(ISelenium myBrowser, string strUser)
        {
            //string strUser;
            _isUpdateCustomersResourceFile = false;
            //string suspCust = "SuspCust";
            ...
            if (strUser != "Fail")
            {
                _common.SearchCustomer(strUser, myBrowser);
                _common.SelectMainFrame(myBrowser);
