namespace AdminSuite.CommonControls
{
    class EventDetailsPage
    {
        ...
        public const string SelectMarketLstBox = "MktHcapValue";
        ...
        public const string mktBetinRun_Name = "name=MktBetInRun";
        public const string MktBirDelay = "name=MktBirDelay";
