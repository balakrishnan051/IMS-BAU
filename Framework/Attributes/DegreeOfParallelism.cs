...
using Framework;
    namespace MbUnit.Framework
    {
        ...
        public class ParallelismLimitAttribute : TestAssemblyDecoratorPatternAttribute
        {
            ...
            //public ParallelismLimitAttribute(int degreeOfParallelism)
            //{
            ...
            protected override void DecorateAssemblyTest(IPatternScope assemblyScope, IAssemblyInfo assembly)
            {
                ...
                {
                    FrameGlobals.Init();
                    TestAssemblyExecutionParameters.DegreeOfParallelism = FrameGlobals.parallelismCount;
                });
            }
        }
    }
